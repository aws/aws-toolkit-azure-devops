...
import Parameters = require('./helpers/DeleteStackTaskParameters');
import Operations = require('./helpers/DeleteStackTaskOperations');
...
function run(): Promise<void> {
    ...
    return Operations.TaskOperations.deleteStack(taskParameters);
}
