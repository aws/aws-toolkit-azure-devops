...
import Parameters = require('./helpers/RunCommandTaskParameters');
import Operations = require('./helpers/RunCommandTaskOperations');
...
function run(): Promise<void> {
    ...
    return Operations.TaskOperations.runCommand(taskParameters);
}
