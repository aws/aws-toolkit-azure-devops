...
import Parameters = require ('./helpers/GetParameterTaskParameters');
import Operations = require('./helpers/GetParameterTaskOperations');
...
function run(): Promise<void> {
    ...
    return Operations.TaskOperations.getParameterValues(taskParameters);
}
