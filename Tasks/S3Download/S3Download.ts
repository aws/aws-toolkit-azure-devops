...
import Parameters = require('./helpers/DownloadTaskParameters');
import Operations = require('./helpers/DownloadTaskOperations');
...
function run(): Promise<void> {
    ...
    return Operations.TaskOperations.downloadArtifacts(taskParameters);
}
