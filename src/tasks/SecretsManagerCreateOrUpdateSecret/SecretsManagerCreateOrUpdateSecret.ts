...
import { createDefaultSecretsManager } from 'lib/defaultClients'
...
async function run(): Promise<void> {
    ...
    return new TaskOperations(await createDefaultSecretsManager(taskParameters, tl.debug), taskParameters).execute()
}
